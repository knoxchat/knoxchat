...
| ![](https://docs.knox.chat/img/knox.png) |
|-|
...
### **Getting Help**
- **Documentation**: [https://docs.knox.chat/](https://docs.knox.chat/)
- **GitHub Issues**: [Report bugs and request features](https://github.com/knoxchat/knox/issues)
